                        ...
                        <br/> <br/> 
                                <div class='col-md-12'>
                                    <table class='table table-bordered table-condensed '>
                                        ...
                                        <tbody>
                                            <?php
                                                $accounts=$con->myQuery("SELECT account_name,industry,address,account_handler,account_status,id FROM qry_accounts where is_deleted=0")->fetchAll(PDO::FETCH_ASSOC);
