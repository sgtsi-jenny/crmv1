            ...
            <div class='row'>
                ...
                <div class='col-md-3'>
                    ...
                    <div class='row'>
                        <div class="list-group">
                          ...
                          <span href="" class="list-group-item active">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Invoices</span>
                ...
                <div class='col-md-9'>
                                ...
                                <div class='panel-body'>
                                    <br/>
                                    <div class='col-md-12 text-right'>
                                        <button class='btn btn-success' data-toggle="collapse" data-target="#collapseForm" aria-expanded="false" aria-controls="collapseForm">Add New Invoice <span class='fa fa-plus'></span> </button>
                                    </div> 
                                </div>
                                <?php
                                Alert();
                            ...
                            <div id='collapseForm' class='collapse'>
                              <form class='form-horizontal' action='save_opp_invoice.php' onsubmit="return validatePost(this)" method="POST" >
                                 ...
                                 <input type='hidden' name='opp_quote' value='<?php echo !empty($invoices)?$invoices['id']:""?>'>
                                ...
                                <div class='form-group'>
                                    ...
                                    <div class='col-sm-5'>
                                        ...
                                        <input type='file' class='form-control' name='file' <?php echo !empty($invoices['id'])?"":'required=""'?>>
                                    </div>
                                </div>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    ?>
                                                    <td align="center">
                                                        <a href='opp_invoice.php?id=<?php echo $opp['id']?>&invoice_id=<?php echo $row['id']?>' class='btn btn-sm btn-success'><span class='fa fa-pencil'></span></a>
