            ...
            <div class='row'>
                ...
                <div class='col-md-3'>
                    ...
                    <div class='row'>
                        <div class="list-group">
                          ...
                          <span href="" class="list-group-item active">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Quotations</span>
                ...
                <div class='col-md-9'>
                                ...
                                <div class='panel-body'>
                                    <br/>
                                    <div class='col-md-12 text-right'>
                                        <button class='btn btn-success' data-toggle="collapse" data-target="#collapseForm" aria-expanded="false" aria-controls="collapseForm">Add New Quote <span class='fa fa-plus'></span> </button>
                                    </div> 
                                </div>
                                <?php
                                Alert();
