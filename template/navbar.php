...
<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            ...
            <ul class="nav navbar-top-links navbar-left navbar-collapse">
                ...
                ?>
                        ...
                        <li>
                            <a href="organizations.php"><i class="fa fa-users "></i> Customers</a>
                        </li>
                        <li>
            ...
            <ul class="nav navbar-top-links navbar-right navbar-collapse">
                <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-user">
                            ...
                            <li><a href="frm_organizations.php"><i class="fa fa-group"></i> Customers</a>
                            </li>
                ...
                ?>  
                <li class="dropdown">
                    <a href="settings_user.php"><i class="fa fa-gear "></i></a>
                </li>
               <?php
                    endif;
                ?>
