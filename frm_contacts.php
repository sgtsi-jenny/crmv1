...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Contacts Form</h1>
                </div>
                ...
                <div class='col-lg-12'>
                    ...
                    <div class='row'>
                    	<div class='col-sm-12 col-md-8 col-md-offset-2'>
                    		<form class='form-horizontal' method='POST' enctype="multipart/form-data" action='save_contact.php'>
                                ...
                                <div class='form-group'>
                                    <label class='col-sm-12 col-md-3 control-label'> Assigned To</label>
                                    <div class='col-sm-12 col-md-9'>
