<?php
    ...
    if(!empty($_GET['id'])){
        $account=$con->myQuery("SELECT name, id FROM opp_statuses WHERE id=?",array($_GET['id']))->fetch(PDO::FETCH_ASSOC);
        if(empty($account)){
...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Sales Stage</h1>
                </div>
                ...
                <div class='col-lg-12'>
                    ...
                    <div class='row'>
                    	<div class='col-sm-12 col-md-8 col-md-offset-2'>
                    		<form class='form-horizontal' method='POST' enctype="multipart/form-data" action='save_oppstat.php'>
                                ...
                                <div class='form-group'>
                                    ...
                                    <div class='col-sm-12 col-md-9'>
                                        <input type='text' class='form-control' name='name' placeholder='Level' value='<?php echo !empty($account)?$account['name']:"" ?>' required>
                                    </div>
                                </div>
