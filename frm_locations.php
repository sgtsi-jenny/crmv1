<?php
    ...
    if(!empty($_GET['id'])){
        $account=$con->myQuery("SELECT name, id FROM locations WHERE id=?",array($_GET['id']))->fetch(PDO::FETCH_ASSOC);
        if(empty($account)){
                ...
                <div class='col-lg-12'>
                    ...
                    <div class='row'>
                    	<div class='col-sm-12 col-md-8 col-md-offset-2'>
                    		<form class='form-horizontal' method='POST' enctype="multipart/form-data" action='save_locations.php'>
                                ...
                                <div class='form-group'>
                                    ...
                                    <div class='col-sm-12 col-md-9'>
                                        <input type='text' class='form-control' name='name' placeholder='Place, City, Province, etc.' value='<?php echo !empty($account)?$account['name']:"" ?>' required>
                                    </div>
                                </div>
