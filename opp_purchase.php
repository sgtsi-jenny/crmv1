            ...
            <div class='row'>
                ...
                <div class='col-md-3'>
                    ...
                    <div class='row'>
                        <div class="list-group">
                          ...
                          <span href="" class="list-group-item active">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Purchase Order</span>
                ...
                <div class='col-md-9'>
                                ...
                                <div class='panel-body'>
                                    <br/>
                                    <div class='col-md-12 text-right'>
                                        <button class='btn btn-success' data-toggle="collapse" data-target="#collapseForm" aria-expanded="false" aria-controls="collapseForm">Add New Purchase Order <span class='fa fa-plus'></span> </button>
                                    </div> 
                                </div>
                                <?php
                                Alert();
                               ...
                               <div class='form-group'>
                                  ...
                                  <div class="form-group">
                                    <div class="col-sm-10 col-md-offset-2 text-center">
                                      ...
                                      <a href='opp_purchase.php?id=<?php echo $_GET['id'] ?>' class='btn btn-default'>Cancel</a>
                                    </div>
                                  </div>
                              </form>
                            </div>
                    ...
                    <div class='panel panel-default'>
                        <div class='panel-body'>  
                            <div class='col-md-12'>
                                ...
                                <h2>List of Purchase Order Files</h2>
                                <br>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    ?>
                                                    <td align="center">
                                                        <a href='opp_purchase.php?id=<?php echo $opp['id']?>&po_id=<?php echo $row['id']?>' class='btn btn-sm btn-success'><span class='fa fa-pencil'></span></a>
