<?php
    ...
    makeHead("Closed Opportunities Reports");
?>
<div id='wrapper'>
<?php
...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Closed Opportunities Reports</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                            ...
                            <div class='dataTable_wrapper '>
                                <div class='col-md-12'>
                                    <table class='table table-bordered table-condensed ' id='dataTables'>
                                        ...
                                        <tbody>
                                            <?php
                                                $accounts=$con->myQuery("SELECT opp_name, organizations.org_name, opp_statuses.name, CONCAT(users.last_name, ', ', users.first_name) As uname ,(select SUM(opp_products.prod_price) from opp_products where is_deleted=0 and opportunities.id=opp_products.opp_id) FROM opportunities
                                                    ...
                                                    where opportunities.is_deleted=0 and opp_statuses.name like '%Closed Won%'
