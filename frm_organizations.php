<?php
    ...
    if(!empty($_GET['id'])){
        $organization=$con->myQuery("SELECT id,org_name,reg_name,trade_name,tin_num,tel_num,phone_num,email,address,industry,rating,contact_id,org_type,annual_revenue,assigned_to,description FROM organizations WHERE id=?",array($_GET['id']))->fetch(PDO::FETCH_ASSOC);
...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Customer's Form</h1>
                </div>
                ...
                <div class='col-lg-12'>
                    ...
                    <div class='row'>
                    	<div class='col-sm-12 col-md-8 col-md-offset-2'>
                    		<form class='form-horizontal' method='POST' action='save_org.php'>
                                <input type='hidden' name='id' value='<?php echo !empty($organization)?$organization['id']:""?>'>

                                
                    			
                                <!-- <div class='form-group'>
                                    <label class='col-sm-12 col-md-3 control-label'> Customer's Name*</label>
                                    <div class='col-sm-12 col-md-9'>
                                        <input type="text" class="form-control" name="org_name" placeholder="Enter Customer's Name" value="<?php echo !empty($organization)?$organization["org_name"]:"" ?>" required>
                                    </div>
                                </div> -->
                                ...
                                <div class='form-group'>
                                    <div class='col-sm-12 col-md-9 col-md-offset-3 '>
                                        <a href='organizations.php' class='btn btn-default'>Cancel</a>
