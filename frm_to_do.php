...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Creating New To Do</h1>
                </div>
                            ...
                            <form class='form-horizontal' method='POST' action='save_to_do.php'>
                              ...
                              <div class='form-group'>
                               ...
                               <div class='form-group'>
                                    ...
                                    <div class='col-sm-6'>
                                        <input type='text' class='form-control' name='location' placeholder='Enter Location' value='<?php echo !empty($to_do)?$to_do['location']:"" ?>'>
                                    </div>
                                </div>
                                ...
                                <div class='form-group'>
                                    ...
                                    <div class='col-sm-6'>
                                        <textarea class='form-control' name='description' value=''><?php echo !empty($to_do)?$to_do['description']:"" ?></textarea>
                                    </div>
                                </div>
