...
insert  into `activities`(`id`,`opp_id`,`user_id`,`notes`,`page`,`item`,`action_date`) values (3,2,1,'Updated quote id 2','',0,'2016-04-08 00:00:00'),(4,2,2,'Updated quote id 2','',0,'2016-04-08 00:00:00'),(5,2,2,'Updated quote id 2 file.','',0,'2016-04-08 00:00:00'),(6,2,1,'Updated quote id 2 details.','',2,'2016-04-08 00:00:00'),(7,2,1,'Updated quote id 2 details.','quotes',2,'2016-04-08 00:00:00'),(8,2,5,'Updated quote id 1 details.','quotes',1,'2016-04-11 00:00:00'),(86,5,5,'Added a contact ()','',0,'2016-04-15 10:18:08'),(87,5,5,'Added a document (Project Tracker)','',0,'2016-04-15 10:51:53');
...
CREATE TABLE `events` (
  ...
  `opp_id` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=38 DEFAULT CHARSET=utf8 COMMENT='High(1), Medium(2), Low(3)';
...
insert  into `organizations`(`id`,`org_name`,`phone_num`,`email`,`industry`,`address`,`rating`,`org_type`,`annual_revenue`,`assigned_to`,`description`,`date_created`,`date_modified`,`is_deleted`) values (1,'Angono Rizal Project 1','3448009','angono@ymail.com',5,'pasig city phl',1,1,1000000,1,'','2016-03-04 12:36:14','2016-04-12 13:14:21',0),(2,'Euro Shop','1234567','eurosop@ymail.com',10,'Las Pinas',3,2,5000000,2,'test2','2016-03-04 12:36:14','2016-03-04 12:36:14',0),(3,'Landbank','9876543','test@gmail.com',14,'sample',2,3,10000,3,'test3','2016-03-04 12:36:14','2016-03-04 12:36:14',0),(4,'Rustans','1234','',0,'',0,0,0,4,'','2016-03-04 12:36:14','2016-03-04 12:36:14',0),(5,'Unionbank','0987654321','jen@gmail.com',2,'qc commonwealth',2,2,10,2,'test','2016-03-04 12:36:14','2016-03-04 12:36:14',0),(6,'BDO','','',0,'',0,0,0,2,'','2016-03-04 12:36:14','2016-03-04 12:36:14',0),(7,'BHF','0987654321','bh@ymail.com',3,'manila',2,6,0,3,'','2016-03-04 12:36:14','2016-03-04 12:36:14',0),(8,'Bench','9876543','bench@info.com.ph',3,'Makati',2,3,0,2,'','2016-03-15 08:55:38','2016-03-15 08:59:45',0),(9,'DAR','','',3,'',2,3,0,2,'test dar','2016-03-17 09:39:45','2016-03-17 09:39:45',0);
...
CREATE TABLE `users` (
  ...
  `is_deleted` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='Table for users';
